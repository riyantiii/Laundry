...
<!-- end Pengaturan Tampilan Header Admin -->
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Selamat Datang <div class="weight-600 font-30 text-blue">Adibah !</div>
						</h4>
						<p class="font-18 max-width-600">Anda login sebagai Owner</p>
					</div>
				</div>
			</div>
			<div class="row">
	...
	<script src="../admin/scripts/process.js"></script>
	<script src="../admin/scripts/layout-settings.js"></script>
	...
	<script src="../admin/vendors/src/plugins/datatables/js/responsive.bootstrap4.min.js"></script>
