	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6 order-2 order-md-1 text-center text-md-left">
				...
				<a href="login.php" class="btn btn-warning">Order Sekarang</a>
			</div>
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="images/thumbs/pppp-removebg-preview.png" alt="laundry">
			</div>
		</div>
	</div>
</section>
		...
		<div class="rounded shadow p-5 bg-white">
			<div class="row">
				<div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					...
					<h3 class="mt-4 text-capitalize h5 ">Pembersihan noda</h3>
					<p align="justify">laundry premium akan membedakan pakaian yang bisa dicuci dengan mesin wet cleaning atau dry cleaning berdasarkan jenis bahan dan label perawatan yang melekat. Jadi, deterjen saja tidak cukup untuk memberikan perawatan terbaik untuk pakaian kesayangan Anda.</p>
				</div>
				<div class="col-lg-4 col-md-6 mt-5 mt-md-0 text-center">
					<i class="ti-user text-primary h1"></i>
					<h3 class="mt-4 text-capitalize h5 ">Pelanggan</h3>
					<p align="justify">Pelanggan yang sudah tersebar dimana mana membuktikan bahwa laundry premium di skyram sudah terpercaya.</p>
				</div>
				<div class="col-lg-4 col-md-12 mt-5 mt-lg-0 text-center">
					<i class="ti-search text-primary h1"></i>
					<h3 class="mt-4 text-capitalize h5 ">Pengecekan pakaian yang menyeluruh</h3>
					<p align="justify">Tidak semua penyedia layanan laundry melakukan proses ini, misalnya laundry kiloan yang biasanya langsung memproses pakaian. Proses yang detail ini menjadi salah satu alasan mengapa harga layanan laundry premium jauh lebih tinggi.</p>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="images/thumbs/lau1.jpg" alt="lau">
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="images/thumbs/baju.jpg" alt="baju">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-6 align-self-center">
				...
				<div class="service-thumb left" data-aos="fade-right">
					<img class="img-fluid" src="images/thumbs/rapi.jpg" alt="baju">
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="content-block">
					...
					<!-- Popup Video -->
					<a data-fancybox href="https://youtu.be/PanMMullX90?si=ENDWtUAhMMT_avVB">
				...
				<div class="testimonial-slider owl-carousel owl-theme">
					...
					<div class="item">
						<div class="block shadow">
							...
							<!-- Person Thumb -->
							<div class="image">
								<img src="images/thumbs/baju.jpg" alt="image">
							</div>
							<!-- Name and Company -->
							<cite>Abraham Linkon , Themefisher.com</cite>
						</div>
...
<!--====  End of Testimonial  ====-->
  ...
  <div class="text-center bg-dark py-4">
    <small class="text-secondary">Copyright &copy; <script>Laundry.write(new Date().getFullYear())</script>. Designed &amp; Developed by <a href="https://themefisher.com/">Kelompok 5</a></small class="text-secondary">
  </div>

	<div class="text-center bg-dark py-1">
   <small> <p> <a href="https://themewagon.com/"></a></p></small class="text-secondary">
  </div>
</footer>
